...
public class DatabaseSynchronizer implements Servlet {
    ...
    static {
        ...
        // 5.3.6
        updates.put("34", new UpdateElement(Collections.singletonList("add_application_title.sql"), String.class));
        updates.put("35", new UpdateElement(Collections.singletonList("add_application_language.sql"), String.class));
